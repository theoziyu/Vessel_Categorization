...
for category in category_types:
	...
	try:
		...
		os.chdir("/data/u/oguzhancan/mirror-original/")

		if not os.path.exists("mirror_" + catName):
			os.makedirs("mirror_" + catName)
		
		os.chdir("/data/u/oguzhancan/mirror-original/mirror_"+catName)
		
		tag = "mirror_" + filename
