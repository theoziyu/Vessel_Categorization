...
for category in category_types:
	...
	try:
		...
		os.chdir("/data/u/oguzhancan/zoom-original/")

		if not os.path.exists("zoom_" + catName):
			os.makedirs("zoom_" + catName)
		
		os.chdir("/data/u/oguzhancan/zoom-original/zoom_"+catName)
